...
int main() {
	...
	cout << "\n3. Cache completamente asociativa." <<endl;
	cout << "\n4. Cache mas eficiente." <<endl;
	cout << "\n5. Salir.\n" <<endl;
	cin >> opcion;
   ...
   //CACHE MAS EFICIENTE 
          ...
          if (!band3) { // Si el bloque no está en el conjunto 
          ...
          if (!band4) { // Si el bloque no está en la caché 
     	...
     	if (fallo1 <= fallo2 && fallo1 <= fallo3) {              
	  		cout << "La cache mas eficiente es la cache de correspondencia directa.\n" << endl;
    	} else if (fallo2 <= fallo1 && fallo2 <= fallo3) {              
			cout << "La cache mas eficiente es la cache asociativa por conjuntos de dos vias.\n" << endl;
        } else {              
			cout << "La cache mas eficiente es la cache completamente asociativa.\n" << endl;
        } 
